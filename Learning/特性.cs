...
public class 特性 {
    public const string 参考 = "C#之特性 https://blog.csdn.net/weixin_39520967/article/details/122676703";
    #region 已定义的特性
    ...
    public const string 声明一个自定义特性 = """
        定义一个类并且这个类派生自System.Attribute
        类的名字以Attribute结尾
        为了安全性, 可以用一个sealed修饰成一个密封类型(非必须的), 以防止被其他类所继承
        (可以参考预定义特性的源码, 其都被sealed所修饰)
        """;
    public const string 成员 = "特性可以有公有成员，但是公有成员只能是字段, 属性或构造函数";
    public const string 限制特性的使用 = "使用AttributeUsage以限制";
