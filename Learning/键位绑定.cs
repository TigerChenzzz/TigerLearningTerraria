...
public class 键位绑定 {
    ...
    public class PlayerKeybindExample : ModPlayer {
        public static ModKeybind SomeKeybind;
        public override void Load() {
            ExampleKeybind = KeybindLoader.RegisterKeybind(ModInstance, "SomeKeybind", Keys.K);
        }
        public override void ProcessTriggers(TriggersSet triggersSet) {
            if (ExampleKeybind.JustPressed) {
                CombatText.NewText(Main.LocalPlayer.Hitbox, Color.White, "Key pressed!");
            }
        }
    }
}
